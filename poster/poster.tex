...
\vspace{-1.6cm}
        \begin{itemize}
        \item  $t_\mathrm{lib, gap\,edge}=2\pi/|\Omega_k(r_p)-\Omega_k(r_\mathrm{edge})|$ is the time in between
        ...
        \item $\tilde{\beta}\ll 1 \Rightarrow$ fluid at the gap edge
          returns to its initial temperature in between going through planet-induced shocks 
        \end{itemize}
        \end{block}
        \vfill
...
%                    vortex, for different beta}                   
                    ...
                    \end{minipage}    
                    \begin{itemize}
                    \item Slower cooling rate increases
...
%                  number when vortices in quasi-steady state}
              ...
              \item Continuous vorticity source from disk-planet interaction
            ...
            \begin{block}{\Large{Vortex lifetimes and cooling rate}}
              \justifying
              \begin{itemize}
              \item Vortices typically live longer with increasing cooling time:
              \end{itemize}
              \begin{figure}
                \centering
                \includegraphics[width=\textwidth,clip=true,trim=0cm
                  1.5cm 0cm 1cm]{lifetime_regime1}
              \end{figure}
              \vspace{-1cm}
              \begin{itemize}
              \item However, for very long $t_\mathrm{cool}$ vortex
                lifetimes shorten again:
              \end{itemize}
              \begin{figure}
                \centering
                \includegraphics[width=\textwidth,clip=true,trim=0cm
                  0cm 0cm 1cm]{lifetime_regime2}
              \end{figure}
              \vspace{-2cm}
              \begin{itemize}
              \item A cooling time of $\tilde{\beta}\sim 5$ maximizes
                vortex lifetime (thick line)
              \end{itemize}
            \end{block}
            \vfill
            \begin{block}{{\Large Summary}}\justifying
              {\large{\bf
                  The stability of planetary gaps in gaseous
                  protoplanetary disks is affected by disk
                  thermodynamics. A slower cooling rate, which permits
                  more heating, tends to stabilize the system, but
                  also enables longer vortex lifetimes unless the
                  cooling time is extremely long. Our simulations
                  suggest there exists an optimal $t_\mathrm{cool}$
                  that maximizes vortex lifetimes, a result consistent
                  with recent isothermal simulations by Fu et
                  al. (2014,ApJ,788,L41) with variable disk aspect-ratio. 
                }
              }
              \vfill
            \end{block}
