...
state. {\bf We considered the inviscid limit which favors the RWI
  \citep{li09,fu14}, so that the vortex lifetimes observed in our
  simulations are likely longer than in realistic disks with non-zero
  viscosity. }    	
...
increasing cooling time. {\bf We observe vortex migration during this
  decay, which may contribute to this decay timescale.} The sum of
...
{\bf 
  ...
  protoplanetary disks, a more realistic thermodynamics treatment ,
  e.g. based on radiative cooling, should be used in future work.   
}
