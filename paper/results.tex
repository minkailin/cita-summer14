...
(which are obtained with faster cooling rates). {\bf This decay is 
  ...
  its surface density decreases. (true?) (For isothermal and long cases yes. Spiral waves appear in beta=0.1,0.5,1.0})
We will see in the
...
{\bf For comparison we also ran a locally isothermal simulation with results concident with those found in this section.
}
...
{\bf During the quasi-steady state the vortex 
  ...
  vortex migration at this stage (true?:yes), since the vortex is located at a
...
{\bf After full decay the aspect ratio at the outer gap edge is $h\sim0.05$}
