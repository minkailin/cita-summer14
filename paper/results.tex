...
\begin{figure}
  ...
  \caption{Evolution of Rossby numbers at the centres of the vortices
    form in in discs with different cooling rates. A negative Rossby
...
\begin{figure}
  ...
  \caption{The vortex in the case with $\tilde{\beta}=1$
    ...
    shown. This plot is to be considered in conjunction with
...
\begin{figure}
  ...
  \caption{Non-dimensional measure of the surface density gradient at
    the outer gap edge $\tilde\beta=1.0$. A large $\delta\Sigma$
...
{\bf correct interpretation?} (which is on the order of the
...
\begin{figure}
  ...
  \caption{Characteristic timescales associated with vortex evolution, as a function of the cooling
    parameter $\tilde\beta$: $t_\mathrm{diss}$ is when the $m=1$
    surface density amplitude begins to decay (black);
    $t_\mathrm{life}$ is the time at which the over-density at the
    vortex centre decreases to $\Delta\Sigma/\Sigma \sim 1$ after
    reaching maximum (red); and $t_\mathrm{Mach}$ is the time taken
    for the average Mach number around the vortex to maximise
    (blue). \label{betaplot}}  
