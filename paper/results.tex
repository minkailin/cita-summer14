...
{\bf typical rossby numbers for these `planet-off' vortices? do
  stronger vortices (beta=0.1) dissipate faster?
}
...
$\tilde{\beta}=0.5$ and $5.0$. The vortices simply decay on a
timescale of $O(10^3)$ orbits. We will see in the next section that
...
$\tilde\beta=10$ case. %despite beta=10 having the weakest linear
% instability 
{\bf any trend between maximum over-density achieved and cooling?} 
...
perturbation at the outer gap edge, $r\sim r_{p}+2.5r_h$, is 
...
along the wakes is $|\nabla\Sigma/\Sigma| \sim 4 $.{\bf this quantity
  has dimensions of 1/length, preferable to quote something
...
disc. %this effect probably becomes less important for very long
