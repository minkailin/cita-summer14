...
Surface density pertibations relative to the intial disk
...
%, where $H$ denotes the gas scale height, 
are shown in Figure \ref{machplot} for various cooling rates over time.
% $\approx 0.8$ after the intial formation of the vortices for all $\tilde\beta$. 
