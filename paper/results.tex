\section{Numerical linear stability simulations}
...
evolve the disc. %more details on perturbation: m=1 to 10, amplitude?  
%resolution?
%switch off at t=30 because in full disk-planet sims, instability sets
%in soon after planet introduced 
