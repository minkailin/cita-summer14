...
the different $\tilde\beta$ are shown in Fig \ref{2Dlinear}. {\bf Isothermal simulations with set sound speed where also analyzed showing growth rates $\sim 5 \times 10^2 / \Omega(r_p)$. In comparison nearly isothermal simulation with $\tilde\beta=0.01$ had growth rates $\sim 8\times 10^2 / \Omega(r_p)$}
...
\begin{figure}
  ...
  \caption{Relative surface density perturbation for the
    ...
    {\bf The decrease in density pertibation at $r>40r_{in}$ arises from the open
    boundry condition.}
    \label{Vortex2D}} 
\end{figure}
...
{\bf Radial locations of the vortices were found to migrate over their lifetime. During the quasi-steady state the vortices were found to orbit $\sim 6.5r_h$ from the planet radius. Simultaneously with the appearence of wakes, the vortices were found to move towards $\sim 5.3r_h$. This is a result of the the spiral waves transporting angular momentum to the disk (Is this true? Shocks on the inner disk seem stronger so I would think it would migrate outward). After the vortex reaches marginal amplitudes $<1 \Delta\Sigma/\Sigma$ the vortices were found to migrate back out towards $\sim 6.5 r_h$ from the planet location }
