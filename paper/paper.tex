...
%gap edges stabilize with increasing $\beta$ as dominate modes and
%growth rates decrease in value. 
...
%characterized by
%sudden disspation on the order of 100's or planet orbits.
...
%a non-monoticly dependence on $\beta$ and
%an optimum value for cooling rate was found to maximize the lifetime. 

   

%The simulations are customized to examine the stability of gaps
%opened by massive planets as a function of $\beta$.  
